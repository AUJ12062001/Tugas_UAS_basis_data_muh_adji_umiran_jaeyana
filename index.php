  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        <h5 class="modal-title">TABEL DOKTER</h5>
  ...
  <?php 
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td><?php echo $d['tempat_praktek']; ?></td>
				<td>
      ...
      <div class="modal-header"><button onclick='change();'  value='show' id='btn1' type="button" class="btn btn-primary ">TAMBAH DOKTER</button></a>
  </div>
<br>
